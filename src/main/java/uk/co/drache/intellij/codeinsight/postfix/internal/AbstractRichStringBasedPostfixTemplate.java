...
/**
 * Base class that is a modified form of {@link StringBasedPostfixTemplate} that passes the project
 * to {@link AbstractRichStringBasedPostfixTemplate#createTemplate} to allow querying of project
 * properties.
 *
 * @author Bob Browning
 */
public abstract class AbstractRichStringBasedPostfixTemplate
    extends PostfixTemplateWithExpressionSelector {

  protected AbstractRichStringBasedPostfixTemplate(
      @NotNull String name,
      @NotNull String example,
      @NotNull PostfixTemplateExpressionSelector selector) {
    super(null, name, example, selector, null);
  }
  ...
  protected final void expandForChooseExpression(@NotNull PsiElement expr, @NotNull Editor editor) {
    ...
    document.deleteString(
        elementForRemoving.getTextRange().getStartOffset(),
  ...
  protected Template createTemplate(
    ...
    template.setValue(
        Template.Property.USE_STATIC_IMPORT_IF_POSSIBLE, shouldUseStaticImportIfPossible(project));
    return template;
  }
   ...
   */
  protected String getStaticMethodPrefix(
      @NotNull ClassName className, @NotNull String methodName, @NotNull PsiElement context) {
   ...
   */
  protected String getStaticMethodPrefix(
      @NotNull String className, @NotNull String methodName, @NotNull PsiElement context) {
